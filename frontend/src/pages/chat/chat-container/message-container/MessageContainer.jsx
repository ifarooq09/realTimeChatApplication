...
import { GET_GROUP_MESSAGES, GET_MESSAGES_ROUTE, HOST } from "@/utils/constants";
...
const MessageContainer = () => {
  ...
  // Ensure smooth scrolling when messages are updated
  useEffect(() => {
  ...
  const downloadFile = async (url) => {
    ...
    const response = await apiService.get(`${HOST}/${url}`, {
      responseType: "blob",
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full h-full">
      {renderMessages()}
      <div ref={scrollRef} />
      {showImage && (
